...
## [Settings](https://github.com/truedna/Paws/blob/main/.env-example)
...
## Installation
You can download the [**repository**](https://github.com/truedna/Paws) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/truedna/Paws.git
cd Paws
```
